...
// 获取商品详情信息
const getGoodsByIdData = () => {
    getGoodsByIdApi(query.id)
}
    ...
    <scroll-view scroll-y class="viewport">
        ...
        <view class="detail panel">
            ...
            <view class="content">
                ...
                <!-- 图片详情 -->
                <image mode="widthFix" src="https://yanxuan-item.nosdn.127.net/a8d266886d31f6eb0d7333c815769305.jpg">
                </image>
                <image mode="widthFix" src="https://yanxuan-item.nosdn.127.net/a9bee1cb53d72e6cdcda210071cbd46a.jpg">
                </image>
            </view>
        </view>
        ...
        <view class="similar panel">
            ...
            <view class="content">
                <navigator v-for="item in 4" :key="item" class="goods" hover-class="none"
